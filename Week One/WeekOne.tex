...
\subsection{David Larribas}
	...
	\renewcommand{\arraystretch}{1.3}
		...
		\bfseries 	Task		 		& \bfseries Hours Worked	& \bfseries Status	\\
		\hline\hline
					Research and writing on health effects and benefits					& 12.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
					Group direction discussions					& 8.0						& 20\%				\\	
		\hline
		\end{tabular}
	\end{table}
