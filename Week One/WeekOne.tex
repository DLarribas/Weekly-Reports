...
\section{Individual Activity Synopsis}
	...
	\renewcommand{\arraystretch}{1.3}
		...
		\hline\hline	I spent a large amount of time developing two Latex templates; one for the weekly reports and another for large reports that includes a title page.
...
\subsection{Ben Smith}
	...
	I spent a large amount of time developing two Latex templates; one for the weekly reports and another for large reports that includes a title page.
