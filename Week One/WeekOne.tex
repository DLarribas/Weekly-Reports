...
\section{Individual Activity Synopsis}
	...
	\renewcommand{\arraystretch}{1.3}
		...
		\hline\hline	
					...
					Setup Group Collabrative tools					& 2.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
					Elevator Pitch Creation					& 1.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command	
		\hline
		\end{tabular}
	\end{table}
