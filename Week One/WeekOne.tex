...
\subsection{Ben Smith}
	...
	\renewcommand{\arraystretch}{1.3}
		...
		\hline\hline
					Design Idea Contract			& 20						& 0\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
