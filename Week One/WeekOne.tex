...
\section{Individual Activity Synopsis}
	...
	\\
	I setup our group tools.  \\
	\\
	I worked on my weekly report.\\
	\\
	...
	\renewcommand{\arraystretch}{1.3}
		...
		\hline\hline
					Societal problem - readings and research					& 9.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
					Societal Problem - paper outline					& 2.0						& 100\%				\\
					Project research and features					& 4.0						& 40\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
					Decide problem topic					& 5.0						& 100\%				\\	
					Setup workspace/collaborative tools					& 2.0						& 100\%				\\	%| Percentage signs are escaped by a \ to indicate they are not a LaTeX command
					I					& 2.0						& 20\%				\\
		\hline
		\end{tabular}
	\end{table}
